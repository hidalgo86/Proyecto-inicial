export const validate = (dog) => {
  ...
  if (
    ...
    error.name = "Only alphabetic characters are allowed";
  }
  //************************ validate heightMin ******************************/
  if (dog.heightMin === "") {
  ...
  if (dog.lifeSpanMin === "") {
    error.lifeSpanMin = "Life span min is required";
  }
  if (dog.lifeSpanMin > dog.lifeSpanMax) {
    error.lifeSpanMin = "min > max";
  }
  //************************ validate lifeSpanMax ******************************/
  if (dog.lifeSpanMax === "") {
    error.lifeSpanMax = "Life span max is required";
  }
